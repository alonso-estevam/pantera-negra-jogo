function confereResposta() {
    ...
    if (respostaJogador.toUpperCase() === respostaCerta) {
        alert("Parabéns! Você foi estrategista ao tentar evitar uma luta desnecessária e demonstrou habilidades de negociação, fundamentais para um líder. Ganhou 50xp");
        ...
        alert("Você escolheu lutar com Klaue! Corajoso, porém, o vilão conseguiu fugir. Você e sua equipe ainda fazem uma grande perseguição, mas Klaue escapa. Pelo menos vocês resgataram o artefato. Ganhou 20xp");
        window.location.replace('tchalla-fase4.html');
